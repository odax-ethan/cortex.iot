...
exports.systemConfigTemplate = {
    ...
    devices: [
       ...
       { deviceID: "Light", deviceTYPE:"relay", devicePIN: 8, deviceNODE:"testboard", relayType: "NO", deviceCONTROLS: "light"},
       { deviceID: "Heater", deviceTYPE:"relay", devicePIN: 10, deviceNODE:"testboard", relayType: "NO", deviceCONTROLS: "heater"},
