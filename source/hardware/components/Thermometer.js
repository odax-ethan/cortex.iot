...
class THERMOMETER {
    ...
    build () {
        ...
        this.device_container = new five.Thermometer({id:this.uid, pin: this.device.pin, controller: this.device.controller, freq: process.env.HARDWARE_SAMPLE_RATE , board: this.device.board})
