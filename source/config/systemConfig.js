...
// deviceTYPE:"relay"
    ...
    const devices = [
             ...
             { deviceID: "Light", deviceTYPE:"relay", devicePIN: 13, deviceNODE:"testboard", relayType: "NO", deviceCONTROLS: "light", color: "rgb(14, 240, 138)"}
      ];
...
const crons = [
         { cronID: "morning fans",  deviceBOARDS:"testboard", deviceID: "test-relay" , cronTYPE:"burt", cronOBJ: ' */15 * * * * * ', cronEventLength: 5000, color: "rgba(65, 124, 211, .5)"},
  ];
...
////////////////////////////////////////////////////////////////////////////////
   ...
   const {systemSettings} = require('./accountPreSettings.js');
   ...
   var deviceBank = [] //empty deviceBank array used to define entire system
    ...
    boards.forEach((board,index,arr)=>{
        ...
        deviceBank.push({id:board.id, devices:[], cron: [], color: board.color})
